...
;(function () {
  ...
  function l(e, t) {
    return (
      ...
      function n(r, s) {
        return r
          ? ((s = s.source || s), (s = s.replace(/(^|[^\[])\^/g, '$1')), (e = e.replace(r, s)), n)
          : new RegExp(e, t)
      }
    )
  }
    ...
    if (i || 'function' == typeof n) {
      ...
      try {
        ...
        if (
          ...
          return '<p>An error occurred:</p><pre>' + s(c.message + '', !0) + '</pre>'
        throw c
      }
  }
  var u = {
  ...
  ;(u.bullet = /(?:[*+-]|\d+\.)/),
    (u.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
    (u.item = l(u.item, 'gm')(/bull/g, u.bullet)()),
    (u.list = l(u.list)(/bull/g, u.bullet)('hr', '\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))')(
      'def',
      '\\n+(?=' + u.def.source + ')',
    )()),
    (u.blockquote = l(u.blockquote)('def', u.def)()),
    (u._tag =
      '(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b'),
    (u.html = l(u.html)('comment', /<!--[\s\S]*?-->/)('closed', /<(tag)[\s\S]+?<\/\1>/)(
      'closing',
      /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/,
    )(/tag/g, u._tag)()),
    (u.paragraph = l(u.paragraph)('hr', u.hr)('heading', u.heading)('lheading', u.lheading)(
      'blockquote',
      u.blockquote,
    )('tag', '<' + u._tag)('def', u.def)()),
    (u.normal = a({}, u)),
    (u.gfm = a({}, u.normal, {
      fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,
      paragraph: /^/,
    ...
    (e.prototype.token = function (e, t, n) {
      for (var r, s, i, l, o, h, a, p, c, e = e.replace(/^ +$/gm, ''); e; )
        if (
          ...
          (e = e.substring(i[0].length)),
            (this.tokens.links[i[1].toLowerCase()] = { href: i[2], title: i[3] })
          ...
          for (
            ...
            /^ *-+: *$/.test(h.align[p])
              ...
              ? (h.align[p] = 'left')
              : (h.align[p] = null)
          for (p = 0; p < h.cells.length; p++)
            h.cells[p] = h.cells[p].replace(/^ *\| *| *\| *$/g, '').split(/ *\| */)
          this.tokens.push(h)
  ...
  ;(c._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/),
    ...
    (c.link = l(c.link)('inside', c._inside)('href', c._href)()),
    (c.reflink = l(c.reflink)('inside', c._inside)()),
    (c.normal = a({}, c)),
    (c.pedantic = a({}, c.normal, {
    ...
    (c.breaks = a({}, c.gfm, { br: l(c.br)('{2,}', '*')(), text: l(c.gfm.text)('{2,}', '*')() })),
    (t.rules = c),
      ...
      for (var t, n, r, i, l = ''; e; )
        if ((i = this.rules.escape.exec(e))) (e = e.substring(i[0].length)), (l += i[1])
          ...
          (e = e.substring(i[0].length)),
            '@' === i[2]
              ? ((n = s(
                  ':' === i[1].charAt(6) ? this.mangle(i[1].substring(7)) : this.mangle(i[1]),
                )),
          ...
          if ((i = this.rules.tag.exec(e)))
            ...
            (e = e.substring(i[0].length)), (l += this.renderer.strong(this.output(i[2] || i[1])))
          else if ((i = this.rules.em.exec(e)))
            (e = e.substring(i[0].length)), (l += this.renderer.em(this.output(i[2] || i[1])))
          else if ((i = this.rules.code.exec(e)))
            (e = e.substring(i[0].length)), (l += this.renderer.codespan(s(i[2].trim(), !0)))
          else if ((i = this.rules.br.exec(e)))
            (e = e.substring(i[0].length)), (l += this.renderer.br())
          else if ((i = this.rules.del.exec(e)))
            (e = e.substring(i[0].length)), (l += this.renderer.del(this.output(i[1])))
          else if ((i = this.rules.text.exec(e)))
            (e = e.substring(i[0].length)), (l += this.renderer.text(s(this.smartypants(i[0]))))
          else if (e) throw new Error('Infinite loop on byte: ' + e.charCodeAt(0))
        } else
          (e = e.substring(i[0].length)),
            (n = s(i[1])),
