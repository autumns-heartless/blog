var introduce =
  '\n  /*我叫张三，来自山西运城*/\n  /*我今年18岁，毕业于哈佛商学院，吹牛大王专业*/\n  /*接触前端10年，我的理想是当一名前端工程师*/\n  /*来看看我为你准备的菜，先来点CSS，加点基本样式......*/'
...
## 博客
- 博客：[我的博客](https://qtmyx.netlify.app/)
`
...
function put() {
  ...
  if (n > maxlength && n < 2560) {
    var drawBoard = document.getElementById('drawBoard')
    drawBoard.innerHTML = str.substring(maxlength, n)
    $('#drawBoard').animate({ scrollTop: 1000 }, 50)
  }
  if (n >= 2560) {
    sourceBoard.innerHTML =
      Prism.highlight(str.substring(0, maxlength), Prism.languages.css) +
      Prism.highlight(str.substring(2560, n), Prism.languages.css)
  }
  if (n >= 2660) {
    var drawBoard = document.getElementById('drawBoard')
    drawBoard.innerHTML = marked(str.substring(maxlength, 2560))
    if (n > str.length) {
