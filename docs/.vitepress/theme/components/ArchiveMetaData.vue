<template>
  <div class="meta-wrapper">
    ...
    <div class="meta-item" v-if="showViewCount">
      ...
      <span class="meta-content" v-text="viewCount" :title="String(viewCount)"></span>
    </div>
...
import { goToLink } from '../utils/archive/archive'
...
const { showViewCount, viewCount, date, tags } = toRefs(data)
