...
import VipDiyToolBarSlot1 from './VipDiyToolBarSlot1.vue';
...
export default {
  ...
  methods: {
    async showGraph() {
      ...
      await graphRef.setJsonData(__graph_json_data, async(graphInstance) => {
...
<template>
  <div :style="{'margin-left':(options.viewELSize.width-160)+'px','margin-top':(options.viewELSize.height-260)/2+'px'}" style="" class="c-mini-toolbar">
    <div class="c-mb-button" style="border-top-left-radius: 18px;border-top-right-radius: 18px;" @click="about">
      ...
      <span class="c-mb-text">Say hi</span>
    </div>
    <div style="float:left;margin-top:0px;height:30px;width:100%;border-top:0px;border-bottom:0px;background-color: #00bb00;color: #ffffff;font-size: 10px;text-align: center;line-height: 30px;" @click="printGraphJsonData">{{ options.canvasZoom }}%</div>
    ...
    <div class="c-mb-button">
      ...
      <span class="c-mb-text">比例</span>
      <div class="c-mb-child-panel" style="width:256px;margin-left:-255px;">
        <div :class="{'c-mb-button-on':options.canvasZoom===40}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(40)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-hj2"></use></svg>
          <span class="c-mb-text">40</span>
        </div>
        <div :class="{'c-mb-button-on':options.canvasZoom===60}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(60)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-lianjieliu"></use></svg>
          <span class="c-mb-text">60</span>
        </div>
        <div :class="{'c-mb-button-on':options.canvasZoom===80}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(80)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-lianjieliu"></use></svg>
          <span class="c-mb-text">80</span>
        </div>
        <div :class="{'c-mb-button-on':options.canvasZoom===100}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(100)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-lianjieliu"></use></svg>
          <span class="c-mb-text">100</span>
        </div>
        <div :class="{'c-mb-button-on':options.canvasZoom===150}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(150)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-hj2"></use></svg>
          <span class="c-mb-text">150</span>
        </div>
      </div>
    </div>
    <div v-if="options.allowShowDownloadButton" class="c-mb-button" style="border-bottom-left-radius: 18px;border-bottom-right-radius: 18px;">
      <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-ziyuan"></use></svg>
      <span class="c-mb-text">下载</span>
      <div :style="{width:'256px','margin-left':'-256px'}" class="c-mb-child-panel">
        ...
        <div class="c-mb-button c-mb-button-c" style="width: 50px;" @click="downloadAsFile('excel')">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-ziyuan"></use></svg>
          <span class="c-mb-text">Excel</span>
        </div>
        <div class="c-mb-button c-mb-button-c" style="width: 50px;" @click="downloadAsFile('excel')">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-ziyuan"></use></svg>
          <span class="c-mb-text">Word</span>
        </div>
        <div class="c-mb-button c-mb-button-c" style="width: 50px;" @click="downloadAsFile('excel')">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-ziyuan"></use></svg>
          <span class="c-mb-text">Pdf</span>
        </div>
      </div>
    </div>
  </div>
...
import { RelationGraphComponent, RGJsonData, RGNode, RGLine, RGLink, RGUserEvent, RGOptions } from 'relation-graph-vue3';
import VipDiyToolBarSlot1 from './VipDiyToolBarSlot1.vue';
...
const showGraph = async () => {
    const __graph_json_data: RGJsonData = {
        ...
        'nodes': [
            ...
            { 'id': '8', 'text': 'Automotive Technology', 'data': null },
...
<template>
  <div :style="{'margin-left':(options.viewELSize.width-160)+'px','margin-top':(options.viewELSize.height-260)/2+'px'}" style="" class="c-mini-toolbar">
    ...
    <div style="float:left;margin-top:0px;height:30px;width:100%;border-top:0px;border-bottom:0px;background-color: #00bb00;color: #ffffff;font-size: 10px;text-align: center;line-height: 30px;" @click="printGraphJsonData">{{ options.canvasZoom }}%</div>
    <div class="c-mb-button" style="margin-top:0px;" @click="zoomToFit()">
      <svg t="1690565818186" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7654" width="16" height="16"><path d="M695.3216 232.531968l66.466816-118.808576c4.381696-7.83872 1.589248-17.7408-6.250496-22.119424-7.85408-4.380672-17.741824-1.5872-22.119424 6.25152l-67.070976 119.912448c-47.051776-21.433344-99.311616-33.370112-154.348544-33.370112-55.04 0-107.300864 11.935744-154.351616 33.368064L290.578432 97.85344c-4.379648-7.83872-14.280704-10.631168-22.119424-6.25152-7.83872 4.379648-10.631168 14.281728-6.25152 22.119424l66.466816 118.807552C215.026688 296.830976 138.28096 419.081216 138.28096 559.415296c0 207.125504 167.325696 375.054336 373.71904 375.054336 206.37696 0 373.71904-167.927808 373.71904-375.054336C885.71904 419.083264 808.967168 296.833024 695.3216 232.531968zM351.116288 512.004096c-22.38976 0-40.621056-18.168832-40.621056-40.62208 0-22.436864 18.234368-40.621056 40.621056-40.621056 22.388736 0 40.621056 18.184192 40.621056 40.621056C391.737344 493.835264 373.505024 512.004096 351.116288 512.004096zM672.883712 512.004096c-22.376448 0-40.62208-18.168832-40.62208-40.62208 0-22.436864 18.245632-40.621056 40.62208-40.621056 22.500352 0 40.621056 18.184192 40.621056 40.621056C713.504768 493.835264 695.384064 512.004096 672.883712 512.004096z" p-id="7655" fill="#707070"></path></svg>      <span class="c-mb-text">Fit</span>
    </div>
    <div class="c-mb-button">
      <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-hj2"></use></svg>
      <span class="c-mb-text">Scale</span>
      <div class="c-mb-child-panel" style="width:256px;margin-left:-255px;">
        <div :class="{'c-mb-button-on':options.canvasZoom===40}" class="c-mb-button c-mb-button-c" style="width: 50px;" @click="relationGraph.setZoom(40)">
          <svg class="rg-icon" aria-hidden="true"><use xlink:href="#icon-hj2"></use></svg>
          <span class="c-mb-text">40</span>
...
import type { RGNode, RGLine, RGLink, RGUserEvent, RGOptions, RGJsonData, RelationGraphComponent } from 'relation-graph-vue3';
...
const switchLayout = (layoutConfig) => {
    relationGraph.switchLayout(layoutConfig, options);
    refresh();
};
...
import RelationGraph, { RelationGraphComponent, RGJsonData, RGNode, RGLine, RGLink, RGUserEvent, RGOptions } from 'relation-graph-react';
import VipDiyToolBarSlot1 from './VipDiyToolBarSlot1';
  ...
  const showGraph = async () => {
    const __graph_json_data: RGJsonData = {
      ...
      nodes: [
        ...
        { id: '8', text: 'Automotive Technology' },
    ...
    <div>
      <div style={{ height: '100vh' }}>
        <RelationGraph
          ref={graphRef}
          options={graphOptions}
          toolBarSlot={VipDiyToolBarSlot1}
        >
        </RelationGraph>
      </div>
    </div>
...
import './VipDiyToolBarSlot1.scss'

const VipDiyToolBarSlot1 = () => {
  ...
  return (
    <div
      style={{
        marginLeft: `${options.viewELSize.width - 160}px`,
        marginTop: `${(options.viewELSize.height - 260) / 2}px`,
      }}
    ...
    >
      <div
        ...
        onClick={about}
      >
        <CircumIcon name="alarm_on" />
        <div className="c-mb-text">Say hi</div>
      </div>
      <div
        style={{
          marginTop: '0px',
      ...
      <div className="c-mb-button" style={{ marginTop: '0px' }} onClick={zoomToFit}>
        <svg
          t="1690565818186"
          className="icon"
        ...
        >
          <path
            d="M695.3216 232.531968l66.466816-118.808576c4.381696-7.83872 1.589248-17.7408-6.250496-22.119424-7.85408-4.380672-17.741824-1.5872-22.119424 6.25152l-67.070976 119.912448c-47.051776-21.433344-99.311616-33.370112-154.348544-33.370112-55.04 0-107.300864 11.935744-154.351616 33.368064L290.578432 97.85344c-4.379648-7.83872-14.280704-10.631168-22.119424-6.25152-7.83872 4.379648-10.631168 14.281728-6.25152 22.119424l66.466816 118.807552C215.026688 296.830976 138.28096 419.081216 138.28096 559.415296c0 207.125504 167.325696 375.054336 373.71904 375.054336 206.37696 0 373.71904-167.927808 373.71904-375.054336C885.71904 419.083264 808.967168 296.833024 695.3216 232.531968zM351.116288 512.004096c-22.38976 0-40.621056-18.168832-40.621056-40.62208 0-22.436864 18.234368-40.621056 40.621056-40.621056 22.388736 0 40.621056 18.184192 40.621056 40.621056C391.737344 493.835264 373.505024 512.004096 351.116288 512.004096zM672.883712 512.004096c-22.376448 0-40.62208-18.168832-40.62208-40.62208 0-22.436864 18.245632-40.621056 40.62208-40.621056 22.500352 0 40.621056 18.184192 40.621056 40.621056C713.504768 493.835264 695.384064 512.004096 672.883712 512.004096z"
            p-id="7655"
            fill="#707070"
          ></path>
        </svg>
        <div className="c-mb-text">Fit</div>
      </div>
      <div className="c-mb-button">
        <svg className="rg-icon" aria-hidden="true">
          <use xlinkHref="#icon-hj2"></use>
        </svg>
        <div className="c-mb-text">Scale</div>
        <div className="c-mb-child-panel" style={{ width: '256px', marginLeft: '-255px' }}>
          <div
            className={`c-mb-button ${options.canvasZoom === 40 ? 'c-mb-button-on' : ''}`}
            style={{ width: '50px' }}
            onClick={() => graphInstance.setZoom(40)}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-hj2"></use>
            </svg>
            <div className="c-mb-text">40</div>
          </div>
          <div
            className={`c-mb-button ${options.canvasZoom === 60 ? 'c-mb-button-on' : ''}`}
            style={{ width: '50px' }}
            onClick={() => graphInstance.setZoom(60)}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-lianjieliu"></use>
            </svg>
            <div className="c-mb-text">60</div>
          </div>
          <div
            className={`c-mb-button ${options.canvasZoom === 80 ? 'c-mb-button-on' : ''}`}
            style={{ width: '50px' }}
            onClick={() => graphInstance.setZoom(80)}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-lianjieliu"></use>
            </svg>
            <div className="c-mb-text">80</div>
          </div>
          <div
            className={`c-mb-button ${options.canvasZoom === 100 ? 'c-mb-button-on' : ''}`}
            style={{ width: '50px' }}
            onClick={() => graphInstance.setZoom(100)}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-lianjieliu"></use>
            </svg>
            <div className="c-mb-text">100</div>
          </div>
          <div
            className={`c-mb-button ${options.canvasZoom === 150 ? 'c-mb-button-on' : ''}`}
            style={{ width: '50px' }}
            onClick={() => graphInstance.setZoom(150)}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-hj2"></use>
            </svg>
            <div className="c-mb-text">150</div>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="c-mb-text">Download</div>
        <div style={{ width: '256px', marginLeft: '-256px' }} className="c-mb-child-panel">
          <div
            className="c-mb-button c-mb-button-c"
            style={{ width: '50px' }}
            onClick={() => graphInstance.downloadAsImage('png')}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-tupian"></use>
            </svg>
            <div className="c-mb-text">PNG</div>
          </div>
          <div
            className="c-mb-button c-mb-button-c"
            style={{ width: '50px' }}
            onClick={() => graphInstance.downloadAsImage('jpg')}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-tupian"></use>
            </svg>
            <div className="c-mb-text">JPG</div>
          </div>
          <div
            className="c-mb-button c-mb-button-c"
            style={{ width: '50px' }}
            onClick={() => downloadAsFile('excel')}
          >
            <svg className="rg-icon" aria-hidden="true">
              <use xlinkHref="#icon-ziyuan"></use>
            </svg>
            <div className="c-mb-text">Excel</div>
          </div>
          <div
            className="c-mb-button c-mb-button-c"
            style={{ width: '50px' }}
          ...
          >
            ...
            <div className="c-mb-text">Word</div>
          </div>
          <div
            className="c-mb-button c-mb-button-c"
            style={{ width: '50px' }}
          ...
          >
            ...
            <div className="c-mb-text">Pdf</div>
          </div>
        </div>
      </div>
    </div>
...
export default VipDiyToolBarSlot1
```

### `VipDiyToolBarSlot1.scss`
