...
<span class="line"><span>&lt;style lang=&quot;scss&quot; scoped&gt;&lt;/style&gt;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><p>页面效果：</p><p><img src="`+u+`" alt="image" loading="lazy"> 1.2 class、style 的合并</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 同时在引用组件及子组件上分别定义类名，会进行合并。</span></span>
<span class="line"><span>// 父组件</span></span>
<span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;ComAttrs class=&quot;parent-style&quot;&gt;&lt;/ComAttrs&gt;</span></span>
<span class="line"><span>&lt;/template&gt;</span></span>
...
<span class="line"><span>  color: blue;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/style&gt;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><p>页面效果：</p><p><img src="`+g+'" alt="image" loading="lazy"></p><p>仔细观察上图的页面效果展示图，可以发现在父组件引用子组件的时候，我们定义了 id、class 都没有透传给子组件，当我们进行显式绑定后的页面效果如下图：（父级类名虽然透传过来了，但由于存在多个根元素，所以父级的样式还没有起作用）</p><p><img src="'+d+'" alt="image" loading="lazy"></p><h2 id="_3-深层组件继承" tabindex="-1">3.深层组件继承 <a class="header-anchor" href="#_3-深层组件继承" aria-label="Permalink to &quot;3.深层组件继承&quot;">​</a></h2><ul><li>存在两级以上组件进行透传的时候，最底层组件能获取到最顶层透传过来的属性，但是最顶层通过 prop 或者 emits 声明的事件传递给中间层，最底层是没办法获取到的。 按照官方的说法： 声明过的 props 和侦听函数被中间层“消费”了</li><li>组件透传截图</li></ul><p><img src="'+h+'" alt="image" loading="lazy"></p><ul><li>页面效果</li></ul><p><img src="'+q+'" alt="image" loading="lazy"></p><h2 id="_4-禁用-attributes-继承" tabindex="-1">4.禁用 Attributes 继承 <a class="header-anchor" href="#_4-禁用-attributes-继承" aria-label="Permalink to &quot;4.禁用 Attributes 继承&quot;">​</a></h2><ul><li>使用场景： 如果你不想要一个组件自动的继承 attribute(这句话的意思是单个根元素都是自动透传继承的，尤其是类名都会自动透传给子组件，如果你不想要子组件自动继承父组件的样式),就可以在组件选项中设置 inheritAttrs:false。但还是可以通过$attrs 访问到透传过来的属性。 页面效果：</li></ul><p><img src="'+v+`" alt="image" loading="lazy"></p><ul><li>组件选项中设置 inheritAttrs:false， 如果你使用了<code>&lt;script setup&gt;&lt;/script&gt;</code>,你需要一个额外的<code>&lt;script&gt;&lt;/script&gt;</code>块来书写这个选项声明。</li></ul><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
<span class="line"><span>  &lt;div class=&quot;children-style&quot;&gt;</span></span>
<span class="line"><span>    &lt;p&gt;姓名：{{ $attrs.name }}&lt;/p&gt;</span></span>
