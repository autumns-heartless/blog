import{bQ as t,aM as i,w as r,L as n,x as a,J as c,I as b,aZ as p}from"./chunks/framework.DhTiqy6F.js";const u="/blog/assets/FSqCfF4VNHqiPRLRgXs8iFY_BxNXmOBk023gKDw12kg.BLdRjWP1.png",o="/blog/assets/BHWy6b3SwhxqWar7HUIqW8ctN_e906C8I6BdWdGISxM.C_7qqjOM.png",m="/blog/assets/pSou60RRwElNK7OCTW9N99YN07-tA6TYf6PEunxtCx0.DdE4lqhy.png",g="/blog/assets/ZzQX9Wa5qlSJiAONfb1sdD6U3PB9TVRPOxNs_EAf7Q.HwtucAP1.png",d="/blog/assets/4jHuQZ0wj7RZ9S-Vo_NxIHVwcNELcy6G7Dv8Fs2YL8Y.DlFBLepK.png",h="/blog/assets/yIO32EqpjBkIXeamXlkTpiq631FrWFjB2iErl2mX0Kw.BM3BuYJO.png",q="/blog/assets/vpxBQ9X4X4QsCJgn2r-Ky1drDwrU1KAXQ4lPldtHf84.BJo70FZA.png",v="/blog/assets/2lfUxvdQTp4KQREGJ0p-rcP6kov6ovXLbLD6IXDEbU8.DtR9SonO.png",P=JSON.parse('{"title":"Vue3 透传 Attributes","description":"","frontmatter":{"author":"郭春艳","title":"Vue3 透传 Attributes","date":"2020/10/02 21:29","categories":["vue3"],"tags":["vue3"]},"headers":[],"relativePath":"other/vue3/fallthrough-attributes.md","filePath":"other/vue3/fallthrough-attributes.md","lastUpdated":1726822854000}'),y={name:"other/vue3/fallthrough-attributes.md"};function f(k,s,_,A,C,x){const l=p("BackTop"),e=p("ArticleMetadata");return i(),r("div",{"data-pagefind-body":!0},[n(l),s[0]||(s[0]=a("h1",{id:"透传-attributes",tabindex:"-1"},[c("透传 Attributes "),a("a",{class:"header-anchor",href:"#透传-attributes","aria-label":'Permalink to "透传 Attributes"'},"​")],-1)),n(e,{article:{}}),s[1]||(s[1]=b(`<p>直接说透传 Attributes 我们可能是有点陌生，但在组件封装的时候我们常见到的$attrs 肯定是熟悉的，所谓透传就是我们使用$attrs 将父组件的未声明的 Props 直接传递给子组件内部的 HTML 标签或自定义组件。</p><p>使用透传简化了属性传递的流程，我们不需要通过 props 将父组件的属性逐层传递下去，并且可以直接在子组件中访问到父组件的属性。</p><p>透传传递的属性包括变量、方法、class、style 和 id。</p><h2 id="_1-透传-class、style-和-id" tabindex="-1">1.透传 class、style 和 id <a class="header-anchor" href="#_1-透传-class、style-和-id" aria-label="Permalink to &quot;1.透传 class、style 和 id&quot;">​</a></h2><p>1.1 样式可直接透传给子组件</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 父组件中加载子组件，并在父组件中定义类名</span></span>
